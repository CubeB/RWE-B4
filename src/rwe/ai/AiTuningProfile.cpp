...
namespace rwe
{
    ...
    bool applyAiTuning(AiTuningProfile& p, const std::string& knob, const std::string& value)
    {
        ...
        return setInt("openingMetalExtractorCount", p.openingMetalExtractorCount)
            ...
            || setInt("ferryArmyRuns", p.ferryArmyRuns)
            || setInt("seaTransportReserve", p.seaTransportReserve)
            || setInt("maxSeaTransportCount", p.maxSeaTransportCount)
            || setBool("ferryBoundArmyCap", p.ferryBoundArmyCap)
