...
namespace rwe
{
    ...
    TEST_CASE("tadDecodeBuildStarted", "[tad]")
    {
        SECTION("a building placed on flat ground")
        {
            ...
            TadBytes s{0x09, 0x29, 0x00, 0x01, 0x00, 0x00, 0x00, 0x43, 0x08, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0xc4, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        ...
        SECTION("a unit leaving a factory that stands on a slope")
        {
            ...
            TadBytes s{0x09, 0x6d, 0x00, 0x19, 0x00, 0xcb, 0x67, 0x50, 0x07, 0x00, 0x80, 0x03, 0x00, 0x1b, 0x02, 0x26, 0x03, 0x50, 0x01, 0x00, 0x00, 0xe5, 0x01};
    ...
    {
        // 14733, tick 9916.
        TadBytes s{0x0d, 0x1d, 0xb4, 0x8c, 0x31, 0x72, 0x3f, 0xa1, 0x00, 0x01, 0x9d, 0x7b, 0x03, 0x33, 0x5d, 0xf0, 0x31, 0xd8, 0x93, 0x6c, 0x00, 0xcc, 0x5a, 0xef, 0x04, 0x49, 0x00, 0x97, 0x89, 0xda, 0xfb, 0xf1, 0x03, 0xe6, 0x07, 0x00};
    ...
    {
        // 14733, tick 22.
        TadBytes s{0x10, 0xd1, 0x07, 0x18, 0x00, 0x01, 0x6e, 0xe2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    TEST_CASE("tadDecodeResourceStats", "[tad]")
    {
        SECTION("a player at the start of a game")
        {
            ...
            TadBytes s{0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7a, 0x44, 0x00, 0x00, 0x7a, 0x44, 0x00, 0x00, 0x7a, 0x44, 0x00, 0x00, 0x7a, 0x44, 0x00, 0x00, 0xc8, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x96, 0x42, 0x00, 0x00, 0x80, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x40};
        ...
        SECTION("a watcher's record is the control, and is not a player's")
        {
            ...
            TadBytes s{0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7a, 0x44, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7a, 0x44};
    ...
    TEST_CASE("tadDecodeUnitTable", "[tad]")
    {
        ...
        {
            // The first two entries of demo 14724's 0x1a record, one from each
            // block. The real record is 317 of each.
            TadBytes record{
                0x1a, 0x02, 0x00, 0x00, 0x00, 0x00, 0xb0, 0xca, 0xba, 0x00, 0x18, 0x34, 0x9e, 0x32, 0x1a, 0x02, 0x00, 0x00, 0x00, 0x00, 0x03, 0xb9, 0x87, 0x01, 0x42, 0xda, 0xe4, 0x16, 0x1a, 0x03, 0x00, 0x00, 0x00, 0x00, 0xb0, 0xca, 0xba, 0x00, 0x01, 0x02, 0xff, 0xff};

            auto table = tadDecodeUnitTable(record);
            REQUIRE(table);
            REQUIRE(table->listed.size() == 2);
            REQUIRE(table->restricted.size() == 1);
            ...
            // The restricted block's second field is a flag, not a checksum.
            REQUIRE(table->restricted[0].value == 0xffff0201);
        }
