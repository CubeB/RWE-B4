...
namespace rwe
{
    ...
    namespace
    {
         ...
         * ends -- docs/TOTALA-EXE.md section 110, which UnitBehaviorService
    ...
    TEST_CASE("a build takes as long as it did in a real game", "[build][corpus]")
    {
        ...
        // one (section 110), so its duration is two less; that is the only
    ...
    TEST_CASE("a construction aircraft's cells need the second lathe to land", "[build][corpus]")
    {
        ...
        // against the game it was measured in -- which is the shape section 110
