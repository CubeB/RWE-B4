...
int main(int argc, char* argv[])
{
    try
    {
        ...
        config.buildingHaloStrength = std::min(100u, args.getUint("building-halo-strength", 55));
        config.buildingHaloWidth = std::clamp(args.getUint("building-halo-width", 1), 1u, 8u);
