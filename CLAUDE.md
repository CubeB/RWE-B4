...
- `docs/TOTALA-EXE.md` — the findings, now eighty-eight sections: the flight
  ...
  order (§85), and what makes a patrolling unit leave its route (§86).
  §87 and §88 are the ones to read first if
