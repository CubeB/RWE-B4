...
- [ ] Transports still to do: units ordering themselves aboard (select units, click transport), air transports descending to pick up, `TransportPickup`/`TransportDrop` script hooks, AI use.
