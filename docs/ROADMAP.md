...
- [ ] Transports still to do: units ordering themselves aboard (select units, click transport), `TransportPickup` boom animation timing tied to the actual attach, AI use.
